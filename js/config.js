...
window.V6_CONFIG = {
  ...
  kanbanStatuses: [
    { id: 'Idea',      label: '💡 Idea & Plan',    color: '#64748b', bg: 'rgba(100,116,139,0.12)', desc: { th: 'ช่วงวางแผน/ปั้นไอเดีย ยังไม่เริ่มผลิตเนื้อหา', en: 'Planning stage, drafting ideas before production.' } },
    { id: 'Drafting',  label: '✍️ Drafting Copy',  color: '#a68cff', bg: 'rgba(166,140,255,0.12)', desc: { th: 'กำลังเขียนแคปชั่นและเนื้อหาหลักใน Layer 2', en: 'Writing captions and core content in Layer 2.' } },
    { id: 'Graphic',   label: '🎨 Design & Media', color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', desc: { th: 'ส่งต่อให้ทีมกราฟิกทำรูปภาพหรือตัดต่อวิดีโอ', en: 'Handing off to design team for graphics or video editing.' } },
    { id: 'Review',    label: '🔍 Final QC',       color: '#06b6d4', bg: 'rgba(6,182,212,0.12)', desc: { th: 'ทำเสร็จหมดแล้ว รอตรวจความเรียบร้อยครั้งสุดท้าย', en: 'Production complete, waiting for final quality check.' } },
    { id: 'Scheduled', label: '✅ Ready & Done',   color: '#10b981', bg: 'rgba(16,185,129,0.12)', desc: { th: 'อนุมัติเรียบร้อย พร้อมโพสต์หรือตั้งเวลาแล้ว', en: 'Approved and ready to post or already scheduled.' } },
  ],
